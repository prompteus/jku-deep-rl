...
if __name__ == "__main__":
    ...
    for global_step, transition in data_generator:
        ...
        writer.add_scalar("charts/advantage", transition.gae_advantage.mean().item(), global_step)
