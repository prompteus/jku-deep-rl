...
if __name__ == "__main__":
    ...
    net = ConvertModel(onnx.load(param_file))
    net = net.to(device)
    net.eval()

    # seed = np.loadtxt('/daten/challenge/django/seed.rnd', dtype=np.int)
    # np.random.seed(seed)
    ...
    for i in range(episodes):
        ...
        scores.append(run_episode2(net, env_seed))
        print(scores)
